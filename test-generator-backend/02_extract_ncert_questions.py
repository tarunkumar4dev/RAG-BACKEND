...
=======
INSTRUCTIONS:
1. Extract EVERY question you find â€” exercise questions, in-text questions, examples with solutions, activities, HOTS questions.
2. For each question, identify:
   - The exact question text (copy verbatim from the content â€” do NOT modify or rephrase)
...
ðŸ“Š DATA TABLES: If a question contains a data table (common in Statistics, Economics, Accountancy), 
...
ðŸ“ DIAGRAMS/FIGURES: If a question references a figure, diagram, graph, or construction:
        ...
        for i in range(0, len(rows), 50):
            ...
            try:
                ...
                if "question_table" in err_str or "figure_ref" in err_str:
                    logger.warning("question_table/figure_ref column missing â€” retrying without")
                    for r in batch:
